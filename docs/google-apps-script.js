...
const RSVP_TAB = 'RSVP';
const RSVP_ENDPOINT_VERSION = '2026-07-22-email-v57';
...
function sendRsvpConfirmation(email, name) {
  ...
  const htmlBody = [
    ...
    '<div style="margin:0 0 8px;text-align:center;font-family:\'Snell Roundhand\',\'Segoe Script\',\'Bradley Hand\',Georgia,serif;font-size:28px;font-weight:400;line-height:1.35;color:#4a453f;">M·D</div>',
    ...
    '<p style="margin:0 0 5px;text-align:left;font-family:\'Snell Roundhand\',\'Segoe Script\',\'Bradley Hand\',Georgia,serif;font-size:29px;font-weight:400;line-height:1.35;color:#4a453f;">Minchi &amp; David</p>',
    '<p style="margin:0 0 0 8px;text-align:left;font-family:\'PingFang TC\',\'Noto Sans TC\',Arial,sans-serif;font-size:14px;font-weight:400;line-height:1.5;letter-spacing:.08em;color:#716b63;">旻淇・大為</p>',
    '</td></tr></table>',
    '</td></tr></table>',
    '</div>',
    '</body>',
